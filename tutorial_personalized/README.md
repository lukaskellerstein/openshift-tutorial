...
Each lesson cross-references the comprehensive tutorial in `../tutorial/` for readers who want the full conceptual treatment. The personalized lessons are practical and focused; the existing lessons provide depth.
