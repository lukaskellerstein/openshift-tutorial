...
- [L2-M3.3 Knative & Serverless](../../tutorial/level_2/M3_service_mesh_serverless/3_knative_serverless/) — full Knative Serving and Eventing setup
- [L2-M3.4 Event-Driven Architecture](../../tutorial/level_2/M3_service_mesh_serverless/4_event_driven_architecture/) — CloudEvents, Brokers, Triggers, and Sources in depth
- [L1-M3.3 Scaling & Autoscaling](../../tutorial/level_1/M3_application_deployment/3_scaling_autoscaling/) — HPA fundamentals and comparison with Knative
