# L2-M1.2 — Building Applications with Podman AI Lab
...
- Completed [L2-M1.1 — Custom Models and Catalogs](../1_custom_models_and_catalogs/)
...
3. Select a model (e.g., `granite-3.3-8b-instruct` or the model you imported in L2-M1.1)
4. Click **Start**
...
In [L2-M2.1 — InstructLab Taxonomy and SDG](../../M2_rhel_ai_deep_dive/1_instructlab_taxonomy_and_sdg/), you will dive deep into RHEL AI's fine-tuning workflow: building custom taxonomies, generating synthetic training data, and training a model with the InstructLab LAB method. The models you fine-tune there can be converted to GGUF and brought back into the local development stack you built in this lesson.
