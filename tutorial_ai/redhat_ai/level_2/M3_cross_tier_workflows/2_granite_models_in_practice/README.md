# L2-M3.2 — Granite Models in Practice
...
- Completed all prior lessons in this tutorial (L1-M1 through L2-M3.1)
- Familiarity with the Granite model family (covered in [L1-M1.2](../../../level_1/M1_ecosystem/2_model_strategy/))
- Familiarity with model formats across tiers: GGUF in Podman AI Lab, safetensors/native in RHEL AI, OCI/S3 in OpenShift AI
- Understanding of the cross-tier workflow (covered in [L2-M3.1](../1_end_to_end/))
...
In [L1-M1.2](../../../level_1/M1_ecosystem/2_model_strategy/) you learned that RedHatAI on HuggingFace publishes pre-quantized models in multiple formats. Now we examine the practical trade-offs in depth.
...
- **M2 -- RHEL AI Deep Dive:** InstructLab taxonomy design and synthetic data generation, production deployment with systemd, TLS, multi-model serving, and Prometheus monitoring.
- **M3 -- Cross-Tier Workflows:** The end-to-end seven-step pipeline from desktop to cluster (L2-M3.1), and this lesson on practical model selection, quantization trade-offs, and Granite vs community models (L2-M3.2).
