# L2-M3.1 — End-to-End: Podman AI Lab → RHEL AI → OpenShift AI
...
- Completed: L2-M1 (Advanced Podman AI Lab), L2-M2 (RHEL AI Deep Dive)
...
- **Inference API** -- OpenAI-compatible everywhere. The same `POST /v1/chat/completions` request works against Podman AI Lab's llama.cpp, RHEL AI's vLLM, and OpenShift AI's Red Hat AI Inference Server.
- **Taxonomy format** -- The same InstructLab taxonomy YAML files work on RHEL AI and OpenShift AI's Training Hub.
...
Continue to [L2-M3.2 — Granite Models in Practice](../2_granite_models_in_practice/) to learn how to choose the right Granite model for your task, understand quantization trade-offs, and compare Granite with community models across the Red Hat AI stack.
