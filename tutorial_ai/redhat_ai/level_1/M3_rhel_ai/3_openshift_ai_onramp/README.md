# L1-M3.3 — RHEL AI as an OpenShift AI On-Ramp
...
- The **RHEL AI to OpenShift AI progression is designed to be smooth** — models, taxonomies, and vLLM configurations transfer with minimal modification because both platforms use the same underlying components (vLLM, InstructLab, Granite).
...
Continue to [L1-M4.1 — Validated Patterns for AI](../../M4_validated_patterns/1_validated_patterns_for_ai/) to learn about Red Hat's GitOps-ready reference architectures for production AI deployments — pre-built, tested patterns that accelerate the path from prototype to production.
