...
In [L2-1.2 — Building Applications with Podman AI Lab](../2_building_applications/), you will build a full local AI application stack using the OpenAI-compatible API, integrate a vector database for RAG, and orchestrate everything with Podman Compose.
