# L1-4.2 — Validated Patterns for AI
...
- Completed: [L1-4.1 -- From RHEL AI to OpenShift AI](../1_from_rhel_ai_to_openshift_ai/)
...
Over ten lessons, you explored the full breadth of Red Hat's AI stack:

| Module | What You Learned |
|--------|-----------------|
| **M1: Red Hat AI Platform** | Red Hat AI Enterprise portfolio, three-tier deployment model, Granite model family |
| **M2: Podman AI Lab** | Local AI experimentation -- model catalog, playground, recipes, path to production |
| **M3: RHEL AI** | Single-server inference and model adaptation -- serve, chat, fine-tune with the ilab CLI |
| **M4: Scaling to OpenShift AI** | When and how to scale to OpenShift AI, Validated Patterns for production deployment |

You now understand not just the OpenShift AI platform (covered in the separate OpenShift AI tutorial), but the ecosystem that surrounds it -- from desktop prototyping to single-server inference and fine-tuning to production-ready GitOps deployments.

**Ready for Level 2?** Continue to [L2-1.1 -- Custom Models and Catalogs](../../../level_2/M1_advanced_podman_ai_lab/1_custom_models_and_catalogs/) to go deeper: import custom models into Podman AI Lab, build your own recipe catalogs, explore modular model customization with Docling/SDG Hub/Training Hub, and run end-to-end cross-tier workflows from desktop to cluster.
